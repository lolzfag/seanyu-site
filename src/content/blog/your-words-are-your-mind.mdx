...
description: "Wittgenstein, Shannon, and Kuhn were circling the same idea: every mind carries a trained matrix that wraps thought into words. Conversation is that matrix, applied twice. What falls out of the replacement — for chemistry, class, calibration, and LLMs."
date: 2026-04-18
tags:
  - essays
  - language
...
![Vienna skyline at sunset — the city where Wittgenstein wrote the Tractatus in 1921](/posts/vienna.jpeg)
...
In 1921 Wittgenstein ended his first book with the line about limits. Most readers since have taken it as poetry. It was something stranger — a claim about information that he lacked the mathematics to make cleanly, and his failure to make it cleanly is part of why the twentieth century largely ignored what he was pointing at.
...
Indeed, the *Tractatus* would have said this directly if the vocabulary had existed. But the mathematics Wittgenstein needed were twenty-seven years away. Shannon had not yet written. The word "information" had not yet acquired its technical meaning. He was pointing at a shape he could not outline.

Wittgenstein wrote information theory forty years before Shannon did, in language the twentieth century mistook for poetry.
...
The basic consequence falls out immediately. Two people can know every word the other knows and miss each other entirely. Vocabulary is merely the surface the wrapper operates on. The same mindstream vector, pushed through two different matrices, produces two different outputs. Those outputs, unwrapped by two more matrices on the receiving end, become two different thoughts. Between what you meant and what I understood, there are four transformations, each of them lossy. That any conversation ever works is the surprise worth explaining, rather than the occasional failure.
