...
export const metadata: Metadata = {
  ...
  description:
    "Sean Yu is a founder and operator. Co-founder of Gingercontrol (AI-native trade compliance, gingercontrol.com, 90+ enterprises) and Peony (modern data room, peony.ink, 5,900+ teams). Growth-equity investor at Target Global, then VC at Backed VC. Imperial College London, Biomedical Engineering.",
